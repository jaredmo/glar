...
txt3d_cr_sys
```
Note: See output folder for journal lines with negative debit or credit amount.
...
txt3e
```
Note: See output folder for journal lines with a blank effective date.
...
txt3f
```
Note: See output folder for journal lines with a blank posted date.
...
txt3g
```
Note: See output folder for journal lines with a blank entry description.
...
txt3h
```
Note: See output folder for journal lines with an effective date outside test period.
...
plot3i
```
Note: See output folder for detail.
